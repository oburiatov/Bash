...
source /home/postgres/ks-dmp83.backup.postgres-kubernetes.conf || echo "Need conf file as parameter"
...
kubectl exec --kubeconfig=$KUBECONFIG -n $NAMESPACE -it $POD -- $PG_DUMPALL_PATH  -U $PGUSER > "$DIR/$PGHOST$PGPORT-$DATE".out
